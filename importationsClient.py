...
class Ui_MainWindow(object):
	def setupUi(self, MainWindow):
		...
		spacerItem = QtWidgets.QSpacerItem(
			44, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum
		)
		...
		spacerItem1 = QtWidgets.QSpacerItem(
			52, 24, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum
		)
	...
	def retranslateUi(self, MainWindow):
		...
		self.BCAButton.setText(
			_translate("MainWindow", "Importation\n" "Bons de commandes fournisseurs")
		)
		self.label.setText(
			_translate(
				"MainWindow",
				"Cette interface vous permet d'importer vers Kwisatz : les articles envoyés par la centrale ainsi que\n"
				"vos bons de commandes fournisseurs.",
			)
		)
		self.articlesButton.setText(_translate("MainWindow", "Importation\n" "Articles"))
		self.exportButton.setText(
			_translate("MainWindow", "Exportation des bons\n" "de commandes fournisseurs")
		)
